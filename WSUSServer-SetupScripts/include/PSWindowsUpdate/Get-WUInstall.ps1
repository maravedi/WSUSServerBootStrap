Function Get-WUInstall
{
	...
	.EXAMPLE
		...
		What if: Performing operation "Aktualizacja firmy Microsoft z ekranem wybierania przegl?darki dla u?ytkownik?w systemu W
		indows 7 dla system?w opartych na procesorach x64 w Europejskim Obszarze Gospodarczym (KB976002)[1 MB]?" on Target "KOMP
		UTER".
		What if: Performing operation "Aktualizacja dla systemu Windows 7 dla system?w opartych na procesorach x64 (KB971033)[1
		MB]?" on Target "KOMPUTER".
		What if: Performing operation "Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2533552)[1 MB]?" on Ta
		rget "KOMPUTER".
		What if: Performing operation "Program Microsoft .NET Framework 4 Client Profile w systemie Windows 7 dla system?w opart
		ych na procesorach x64 (KB982670)[1 MB]?" on Target "KOMPUTER".
		What if: Performing operation "Narz?dzie Windows do usuwania z?o?liwego oprogramowania dla komputer?w z procesorem x64 -
		 grudzie? 2011 (KB890830)[1 MB]?" on Target "KOMPUTER".

		X Status     KB          Size Title
		- ------     --          ---- -----
		2 Rejected   KB890830    1 MB Aktualizacja firmy Microsoft z ekranem wybierania przegl?darki dla u?ytkownik?w system...
		2 Rejected   KB890830    1 MB Aktualizacja dla systemu Windows 7 dla system?w opartych na procesorach x64 (KB971033)
		2 Rejected   KB890830    1 MB Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2533552)
		2 Rejected   KB890830    1 MB Program Microsoft .NET Framework 4 Client Profile w systemie Windows 7 dla system?w op...
		2 Rejected   KB890830    1 MB Narz?dzie Windows do usuwania z?o?liwego oprogramowania dla komputer?w z procesorem x6...
	...
	.EXAMPLE
		...
		X Status     KB          Size Title
		- ------     --          ---- -----
		2 Accepted   KB982670   48 MB Program Microsoft .NET Framework 4 Client Profile w systemie Windows 7 dla system?w op...
		3 Downloaded KB982670   48 MB Program Microsoft .NET Framework 4 Client Profile w systemie Windows 7 dla system?w op...
		4 Installed  KB982670   48 MB Program Microsoft .NET Framework 4 Client Profile w systemie Windows 7 dla system?w op...
	...
	.EXAMPLE
		...
		X Status     KB          Size Title
		- ------     --          ---- -----
		2 Accepted   KB2533552   9 MB Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2533552)
		2 Accepted   KB2539636   4 MB Aktualizacja zabezpiecze? dla programu Microsoft .NET Framework 4 w systemach Windows ...
		2 Accepted   KB890830    1 MB Narz?dzie Windows do usuwania z?o?liwego oprogramowania dla komputer?w z procesorem x6...
		3 Downloaded KB2533552   9 MB Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2533552)
		3 Downloaded KB2539636   4 MB Aktualizacja zabezpiecze? dla programu Microsoft .NET Framework 4 w systemach Windows ...
		3 Downloaded KB890830    1 MB Narz?dzie Windows do usuwania z?o?liwego oprogramowania dla komputer?w z procesorem x6...	
		4 Installed  KB2533552   9 MB Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2533552)
		4 Installed  KB2539636   4 MB Aktualizacja zabezpiecze? dla programu Microsoft .NET Framework 4 w systemach Windows ...
		4 Installed  KB890830    1 MB Narz?dzie Windows do usuwania z?o?liwego oprogramowania dla komputer?w z procesorem x6...
	...
	.EXAMPLE
		...
		X Status KB          Size Title
		- ------ --          ---- -----
		1 ------ KB2640148   8 MB Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2640148)
		1 ------ KB2600217  32 MB Aktualizacja dla programu Microsoft .NET Framework 4 w systemach Windows XP, Se...
		1 ------ KB2679255   6 MB Aktualizacja systemu Windows 7 dla komputer?w z procesorami x64 (KB2679255)
